...
import argparse
from Models_Transformers import Transformer_THAT, PositionalEncoding, AutoformerAutoformer, InformerAutoformer, Gaussian_Position, HARTransformerAutoformer, HARInformerAutoformer, HARAutoformerAutoformer, HARTransformer, TransformerAutoformer
...
configs.lr = 0.001
configs.hlayers = 9
configs.hheads = 8 #(input/10) 100, 64, 32, 16, 8, 4, 2
configs.vlayers = 1
...
class THAT(torch.nn.Module):
    def __init__(self, args):
        ...
        self.transformer = HARTransformer(128, args.hlayers, args.hheads, 6)
        self.args = args
        self.kernel_num = 512
...
TransformerModel.load_state_dict(torch.load('THAT_OUISIR'))
