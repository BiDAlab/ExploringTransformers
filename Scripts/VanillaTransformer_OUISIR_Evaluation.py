...
import argparse
from Models_Transformers import Transformer_THAT, PositionalEncoding, HARTransformer, Gaussian_Position, HARTransformerAutoformer, HARInformerAutoformer, HARAutoformerAutoformer, HAR_BRTransformer, TransformerAutoformer
...
class VanillaTransformer(torch.nn.Module):
    def __init__(self, args):
        ...
        self.transformer = TransformerAutoformer(data_length, args.hlayers, args.hheads, dimension)
        self.args = args
        self.kernel_num = 512
        ...
        self.dense2 = torch.nn.Linear(self.kernel_num * len(self.filter_sizes), user_number)
...
TransformerModel.load_state_dict(torch.load('VanillaTransformer_OUISIR'))
