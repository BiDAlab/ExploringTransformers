...
import argparse
from Models_Transformers import Transformer_THAT, PositionalEncoding, BlockRecTransformer, AutoformerAutoformer, InformerAutoformer, Gaussian_Position, HARTransformerAutoformer, HARInformerAutoformer, HARAutoformerAutoformer, HAR_BRTransformer, TransformerAutoformer
...
class BlockRecurrentTransformer(torch.nn.Module):
    def __init__(self, args):
        ...
        self.transformer = BlockRecTransformer(128, 1, args.hheads, 6)
        self.args = args
        self.kernel_num = 512
...
TransformerModel.load_state_dict(torch.load('BlockRecurrent_OUISIR'))
