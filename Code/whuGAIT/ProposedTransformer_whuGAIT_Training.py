...
configs.K = 10 #number of Gaussian distributions
...
##################  DATASET  ######################
training_dataset = torch.load('training_dataset_whuGAIT.pt')
validation_dataset = torch.load('validation_dataset_whuGAIT.pt')
...
class ProposedTransformer(torch.nn.Module):
    def __init__(self, args):
        ...
        self.transformer_pre = HARAutoformerAutoformer(80, args.hlayers, args.hheads, 6)
        self.transformer_rec = HAR_BRTransformer(80, args.hlayers_rec, args.hheads, 6)
        self.transformer_post = HARAutoformerAutoformer(80, args.hlayers_pos, args.hheads, 6)
        self.args = args
        self.kernel_num = 512
...
for epoch in range(EPOCHS):
    ...
    model_path = 'ProposedTransformer_whuGAIT_{}'.format(epoch_number)
